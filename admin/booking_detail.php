...
if (isset($_GET['action'])) {
    ...
    if($_GET["action"] == "done"){
        $id = $_GET["id"];
        $sql = "UPDATE booking SET status='done', action='done' WHERE id='$id'";
                                      ...
                                      <div class="container mb-3 mt-3">
                                          ...
                                          <table class="table table-striped table-bordered mydatatables" style="width: 100%">
                                                ...
                                                if(isset($_POST["filterbooking"])){
                                                    ...
                                                    $sql = "SELECT * FROM booking WHERE status='approved' ORDER BY id";
                                                }
                                                ...
                                                if ($result-> num_rows > 0){
                                                    while ($row = $result-> fetch_assoc()){
                                                        ...
                                                        echo'<td>';
                                                        echo '<a class="w3-button w3-green" href="booking_detail.php?action=done&id=' . $row["id"] . '" >✔</a>';
                                                        echo'</td>';
                                                        echo'</tr>';
